...
export const EL_VYNCE_PRODUCTS = [
  ...
  },
  {
    ...
    description:
      "Cream waffle-knit long sleeve with the EL VYNCE script logo at the chest. Oversized fit, heavyweight textured cotton.",
    inStock: true,
    isNew: true,
  },
  {
    ...
    description:
      "Black waffle-knit long sleeve with the EL VYNCE script logo at the chest. Oversized fit, heavyweight textured cotton.",
    inStock: true,
    isNew: true,
  },
  {
    ...
    description:
      "Brown waffle-knit long sleeve with the EL VYNCE script logo at the chest. Oversized fit, heavyweight textured cotton.",
    inStock: true,
    isNew: true,
  },
  {
    ...
    description:
      "Grey waffle-knit long sleeve with the EL VYNCE script logo at the chest. Oversized fit, heavyweight textured cotton.",
    inStock: true,
    isNew: true,
  },
];
